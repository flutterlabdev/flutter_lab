...
class LabColumn extends StatefulWidget {
  const LabColumn({
    Key? key,
    this.name = "Column",
  ...
  @override
  State<LabColumn> createState() => _LabColumnState();
}

class _LabColumnState extends State<LabColumn> with Cmn {
  final type = WidgetType.Column;
  ...
  @override
  void didUpdateWidget(LabColumn oldWidget) {
